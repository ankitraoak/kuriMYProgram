...
class GetChat:
    async def get_chat(
        ...
        Returns:
            :obj:`~kurimypyrogram.types.Chat` | :obj:`~kurimypyrogram.types.ChatPreview`: On success, if you've already joined the chat, a chat object is returned,
        ...
        Example:
            .. code-block:: python
                ...
                chat = await app.get_chat("kurimypyrogram")
                print(chat)
        """
