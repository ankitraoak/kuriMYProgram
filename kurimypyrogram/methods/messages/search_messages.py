...
from kurimypyrogram import raw, types, utils, enums
...
class SearchMessages:
    ...
    async def search_messages(
        ...
        If you want to get the messages count only, see :meth:`~kurimypyrogram.Client.search_messages_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~kurimypyrogram.enums.MessagesFilter`, *optional*):
