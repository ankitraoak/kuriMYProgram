...
class Chat(Object):
    ...
    Parameters:
        ...
        type (:obj:`~kurimypyrogram.enums.ChatType`):
            Type of chat.
        ...
        usernames (List of :obj:`~kurimypyrogram.types.Username`, *optional*):
        ...
        photo (:obj:`~kurimypyrogram.types.ChatPhoto`, *optional*):
            Chat photo. Suitable for downloads only.

        stories (List of :obj:`~kurimypyrogram.types.Story`, *optional*):
            The list of chat's stories if available.

        wallpaper (:obj:`~kurimypyrogram.types.Document`, *optional*):
            Chat wallpaper.

        bio (``str``, *optional*):
            Bio of the other party in a private chat.
            Returned only in :meth:`~kurimypyrogram.Client.get_chat`.
        ...
        pinned_message (:obj:`~kurimypyrogram.types.Message`, *optional*):
        ...
        restrictions (List of :obj:`~kurimypyrogram.types.Restriction`, *optional*):
            The list of reasons why this chat might be unavailable to some users.
            This field is available only in case *is_restricted* is True.

        permissions (:obj:`~kurimypyrogram.types.ChatPermissions` *optional*):
            Default chat member permissions, for groups and supergroups.

        distance (``int``, *optional*):
            Distance in meters of this group chat from your location.
            Returned only in :meth:`~kurimypyrogram.Client.get_nearby_chats`.

        personal_channel (:obj:`~kurimypyrogram.types.Chat`, *optional*):
            The personal channel linked to this chat.
            Returned only in :meth:`~kurimypyrogram.Client.get_chat`.

        personal_channel_message (:obj:`~kurimypyrogram.types.Message`, *optional*):
            The last message in the personal channel of this chat.
            Returned only in :meth:`~kurimypyrogram.Client.get_chat`.

        linked_chat (:obj:`~kurimypyrogram.types.Chat`, *optional*):
            The linked discussion group (in case of channels) or the linked channel (in case of supergroups).
            Returned only in :meth:`~kurimypyrogram.Client.get_chat`.

        send_as_chat (:obj:`~kurimypyrogram.types.Chat`, *optional*):
            The default "send_as" chat.
            Returned only in :meth:`~kurimypyrogram.Client.get_chat`.

        available_reactions (:obj:`~kurimypyrogram.types.ChatReactions`, *optional*):
        ...
        reply_color (:obj:`~kurimypyrogram.types.ChatColor`, *optional*):
            Chat reply color.

        profile_color (:obj:`~kurimypyrogram.types.ChatColor`, *optional*):
            Chat profile color.

        business_info (:obj:`~kurimypyrogram.types.BusinessInfo`, *optional*):
            Business information of a chat.

        business_intro (:obj:`~kurimypyrogram.types.BusinessIntro`, *optional*):
            For private chats with business accounts, the intro of the business.

        birthday (:obj:`~kurimypyrogram.types.Birthday`, *optional*):
            Information about user birthday.

        raw (:obj:`~kurimypyrogram.raw.base.Chat` | :obj:`~kurimypyrogram.raw.base.User` | :obj:`~kurimypyrogram.raw.base.ChatFull` | :obj:`~kurimypyrogram.raw.base.UserFull`, *optional*):
    ...
    async def archive(self):
        """Bound method *archive* of :obj:`~kurimypyrogram.types.Chat`.
    ...
    async def unarchive(self):
        """Bound method *unarchive* of :obj:`~kurimypyrogram.types.Chat`.
    ...
    async def set_title(self, title: str) -> bool:
        """Bound method *set_title* of :obj:`~kurimypyrogram.types.Chat`.
    ...
    async def set_description(self, description: str) -> bool:
        """Bound method *set_description* of :obj:`~kurimypyrogram.types.Chat`.
    ...
    async def set_photo(
        ...
        *,
        ...
        """Bound method *set_photo* of :obj:`~kurimypyrogram.types.Chat`.
        ...
        Parameters:
            photo (``str`` | ``BinaryIO``, *optional*):
                New chat photo. You can pass a :obj:`~kurimypyrogram.types.Photo` file_id, a file path to upload a new photo
                from your local machine or a binary file-like object with its attribute
                ".name" set for in-memory uploads.

            video (``str`` | ``BinaryIO``, *optional*):
                New chat video. You can pass a :obj:`~kurimypyrogram.types.Video` file_id, a file path to upload a new video
                from your local machine or a binary file-like object with its attribute
                ".name" set for in-memory uploads.
    ...
    async def set_ttl(self, ttl_seconds: int) -> "types.Message":
        """Bound method *set_ttl* of :obj:`~kurimypyrogram.types.Chat`.
        ...
        Returns:
            :obj:`~kurimypyrogram.types.Message`: On success, the generated service message is returned.
        """
    ...
    async def ban_member(
        ...
        """Bound method *ban_member* of :obj:`~kurimypyrogram.types.Chat`.
        ...
        Returns:
            :obj:`~kurimypyrogram.types.Message` | ``bool``: On success, a service message will be returned (when applicable), otherwise, in
    ...
    async def unban_member(
        ...
        """Bound method *unban_member* of :obj:`~kurimypyrogram.types.Chat`.
    ...
    async def restrict_member(
        ...
        Parameters:
            ...
            permissions (:obj:`~kurimypyrogram.types.ChatPermissions`):
        ...
        Returns:
            :obj:`~kurimypyrogram.types.Chat`: On success, a chat object is returned.
    ...
    async def promote_member(
        ...
        """Bound method *promote_member* of :obj:`~kurimypyrogram.types.Chat`.
        ...
        Parameters:
            ...
            privileges (:obj:`~kurimypyrogram.types.ChatPrivileges`, *optional*):
                New user privileges.
    ...
    async def join(self):
        """Bound method *join* of :obj:`~kurimypyrogram.types.Chat`.
    ...
    async def leave(self):
        """Bound method *leave* of :obj:`~kurimypyrogram.types.Chat`.
    ...
    async def export_invite_link(self):
        """Bound method *export_invite_link* of :obj:`~kurimypyrogram.types.Chat`.
    ...
    async def get_member(
        ...
        """Bound method *get_member* of :obj:`~kurimypyrogram.types.Chat`.
        ...
        Returns:
            :obj:`~kurimypyrogram.types.ChatMember`: On success, a chat member is returned.
        """
    ...
    def get_members(
        ...
        """Bound method *get_members* of :obj:`~kurimypyrogram.types.Chat`.
        ...
        Parameters:
            query (``str``, *optional*):
                ...
                A query string is applicable only for :obj:`~kurimypyrogram.enums.ChatMembersFilter.SEARCH`,
                :obj:`~kurimypyrogram.enums.ChatMembersFilter.BANNED` and :obj:`~kurimypyrogram.enums.ChatMembersFilter.RESTRICTED`
                filters only.

            limit (``int``, *optional*):
                Limits the number of members to be retrieved.

            filter (:obj:`~kurimypyrogram.enums.ChatMembersFilter`, *optional*):
                Filter used to select the kind of members you want to retrieve. Only applicable for supergroups
                and channels.

        Returns:
            ``Generator``: On success, a generator yielding :obj:`~kurimypyrogram.types.ChatMember` objects is returned.
        """
    ...
    async def add_members(
        ...
        """Bound method *add_members* of :obj:`~kurimypyrogram.types.Chat`.
    ...
    async def mark_unread(self, ) -> bool:
        """Bound method *mark_unread* of :obj:`~kurimypyrogram.types.Chat`.
    ...
    async def set_protected_content(self, enabled: bool) -> bool:
        """Bound method *set_protected_content* of :obj:`~kurimypyrogram.types.Chat`.
    ...
    async def unpin_all_messages(self) -> bool:
        """Bound method *unpin_all_messages* of :obj:`~kurimypyrogram.types.Chat`.
    ...
    async def mute(self, mute_until: datetime = None) -> bool:
        """Bound method *mute* of :obj:`~kurimypyrogram.types.Chat`.
    ...
    async def unmute(self) -> bool:
        """Bound method *unmute* of :obj:`~kurimypyrogram.types.Chat`.
