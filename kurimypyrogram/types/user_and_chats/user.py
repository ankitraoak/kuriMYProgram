...
from kurimypyrogram import enums, utils
...
class User(Object, Update):
    ...
    Parameters:
        ...
        status (:obj:`~kurimypyrogram.enums.UserStatus`, *optional*):
            User's last seen & online status. ``None``, for bots.

        last_online_date (:py:obj:`~datetime.datetime`, *optional*):
            Last online date of a user. Only available in case status is :obj:`~kurimypyrogram.enums.UserStatus.OFFLINE`.

        next_offline_date (:py:obj:`~datetime.datetime`, *optional*):
            Date when a user will automatically go offline. Only available in case status is :obj:`~kurimypyrogram.enums.UserStatus.ONLINE`.
        ...
        emoji_status (:obj:`~kurimypyrogram.types.EmojiStatus`, *optional*):
            Emoji status.
        ...
        raw (:obj:`~kurimypyrogram.raw.base.User` | :obj:`~kurimypyrogram.raw.base.UserStatus`, *optional*):
    ...
    async def archive(self):
        """Bound method *archive* of :obj:`~kurimypyrogram.types.User`.
    ...
    async def unarchive(self):
        """Bound method *unarchive* of :obj:`~kurimypyrogram.types.User`.
    ...
    def block(self):
        """Bound method *block* of :obj:`~kurimypyrogram.types.User`.
    ...
    def unblock(self):
        """Bound method *unblock* of :obj:`~kurimypyrogram.types.User`.
    ...
    def get_common_chats(self):
        """Bound method *get_common_chats* of :obj:`~kurimypyrogram.types.User`.
