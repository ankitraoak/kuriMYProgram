...
class KeyboardButton(Object):
    ...
    Parameters:
        ...
        request_poll (:obj:`~kurimypyrogram.types.RequestPollInfo`, *optional*):
            If specified, the poll be sent when the button is pressed.

        request_peer (:obj:`~kurimypyrogram.types.RequestPeerTypeChannelInfo` | :obj:`~kurimypyrogram.types.RequestPeerTypeChatInfo` | :obj:`~kurimypyrogram.types.RequestPeerTypeUserInfo`, *optional*):
            If specified, the requested peer will be sent when the button is pressed.

        web_app (:obj:`~kurimypyrogram.types.WebAppInfo`, *optional*):
