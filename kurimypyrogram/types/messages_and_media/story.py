...
from kurimypyrogram import enums, raw, types, utils
from kurimypyrogram.errors import PeerIdInvalid
...
class Story(Object, Update):
    ...
    Parameters:
        ...
        from_user (:obj:`~kurimypyrogram.types.User`, *optional*):
            Sender of the story.

        sender_chat (:obj:`~kurimypyrogram.types.Chat`, *optional*):
            Sender of the story, sent on behalf of a chat.

        date (:py:obj:`~datetime.datetime`, *optional*):
            Date the story was sent.

        chat (:obj:`~kurimypyrogram.types.Chat`, *optional*):
            Conversation the story belongs to.

        forward_from (:obj:`~kurimypyrogram.types.User`, *optional*):
        ...
        forward_from_chat (:obj:`~kurimypyrogram.types.Chat`, *optional*):
        ...
        media (:obj:`~kurimypyrogram.enums.MessageMediaType`, *optional*):
        ...
        photo (:obj:`~kurimypyrogram.types.Photo`, *optional*):
            Story is a photo, information about the photo.

        video (:obj:`~kurimypyrogram.types.Video`, *optional*):
        ...
        caption_entities (List of :obj:`~kurimypyrogram.types.MessageEntity`, *optional*):
        ...
        privacy (:obj:`~kurimypyrogram.enums.StoryPrivacyRules`, *optional*):
            Story privacy.
        ...
        reactions (List of :obj:`~kurimypyrogram.types.Reaction`):
        ...
        raw (``kurimypyrogram.raw.types.StoryItem``, *optional*):
    ...
    async def reply_text(
        ...
        """Bound method *reply_text* of :obj:`~kurimypyrogram.types.Story`.
        ...
        Parameters:
            ...
            entities (List of :obj:`~kurimypyrogram.types.MessageEntity`):
    ...
    async def reply_animation(
        ...
        """Bound method *reply_animation* :obj:`~kurimypyrogram.types.Story`.
        ...
        Returns:
            On success, the sent :obj:`~kurimypyrogram.types.Message` is returned.
            In case the upload is deliberately stopped with :meth:`~kurimypyrogram.Client.stop_transmission`, None is returned
            instead.
    ...
    async def reply_audio(
        ...
        """Bound method *reply_audio* of :obj:`~kurimypyrogram.types.Story`.
    ...
    async def reply_cached_media(
        ...
        """Bound method *reply_cached_media* of :obj:`~kurimypyrogram.types.Story`.
    ...
    async def reply_media_group(
        ...
        """Bound method *reply_media_group* of :obj:`~kurimypyrogram.types.Story`.
        ...
        Parameters:
            media (``list``):
                A list containing either :obj:`~kurimypyrogram.types.InputMediaPhoto` or
                :obj:`~kurimypyrogram.types.InputMediaVideo` objects
        ...
        Returns:
            On success, a :obj:`~kurimypyrogram.types.Messages` object is returned containing all the
    ...
    async def reply_photo(
        ...
        """Bound method *reply_photo* of :obj:`~kurimypyrogram.types.Story`.
    ...
    async def reply_sticker(
        ...
        """Bound method *reply_sticker* of :obj:`~kurimypyrogram.types.Story`.
    ...
    async def reply_video(
        ...
        """Bound method *reply_video* of :obj:`~kurimypyrogram.types.Story`.
    ...
    async def reply_video_note(
        ...
        """Bound method *reply_video_note* of :obj:`~kurimypyrogram.types.Story`.
    ...
    async def reply_voice(
        ...
        """Bound method *reply_voice* of :obj:`~kurimypyrogram.types.Story`.
    ...
    async def copy(
        ...
        """Bound method *copy* of :obj:`~kurimypyrogram.types.Story`.
    ...
    async def delete(self):
        """Bound method *delete* of :obj:`~kurimypyrogram.types.Story`.
    ...
    async def edit_media(
        ...
        """Bound method *edit* of :obj:`~kurimypyrogram.types.Story`.
        ...
        Returns:
            On success, the edited :obj:`~kurimypyrogram.types.Story` is returned.
    ...
    async def edit_caption(
        ...
        """Bound method *edit_caption* of :obj:`~kurimypyrogram.types.Story`.
    ...
    async def edit_privacy(
        ...
        """Bound method *edit_privacy* of :obj:`~kurimypyrogram.types.Story`.
    ...
    async def react(self, emoji: Union[int, str] = None) -> bool:
        """Bound method *react* of :obj:`~kurimypyrogram.types.Story`.
    ...
    async def forward(
        ...
        """Bound method *forward* of :obj:`~kurimypyrogram.types.Story`.
    ...
    async def download(
        ...
        """Bound method *download* of :obj:`~kurimypyrogram.types.Story`.
    ...
    async def read(self) -> List[int]:
        """Bound method *read* of :obj:`~kurimypyrogram.types.Story`.
    ...
    async def view(self) -> List[int]:
        """Bound method *view* of :obj:`~kurimypyrogram.types.Story`.
